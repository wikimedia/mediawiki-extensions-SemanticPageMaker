 ...
 */
class SPMQueryInterface extends UnlistedSpecialPage {
	public function __construct() {
		parent::__construct( 'SPMQueryInterface' );
	}
	/*
	...
	public function execute( $query ) {
		...
		$wgOut->addScript( '<script type="text/javascript" src="' . $wgSPMScriptPath . '/scripts/wf_designer/widgets/datatype/page_ask_qi.js"></script>' );

		$html = '
<hr/>
<input type="button" value="OK" onclick="javascript:update_wf_page_ask_qi()"/>';
