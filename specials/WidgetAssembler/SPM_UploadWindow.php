 ...
 * specials/SF_UploadWindow.php
 *
 * small change for clean wiki output
 */
if ( !defined( 'MEDIAWIKI' ) ) die();

class SPMUploadWindow extends UnlistedSpecialPage {
...
//		wfLoadExtensionMessages( 'SemanticPageMaker' );
	}
	...
	function execute( $query ) {
		...
		$wgUseAjax, $wgAjaxUploadDestCheck, $wgAjaxLicensePreview;
...
/**
 * implements Special:SPMUploadWindow
 * @ingroup SpecialPage
 */
class UploadWindowForm {
	...
	function initializeFromUrl( $request ) {
		...
		$local_file = tempnam( $wgTmpDirectory, 'SPMBUPLOAD' );
